...
public class DetailsRevamp extends BaseActivity<DetailsRevampPresenter>
        implements IDetailsRevamp.View{
    ...
    @Override
    protected DetailsRevampPresenter initPresent(){
        return new DetailsRevampPresenter(this);
    }
    @Override
    ...
    @OnClick(R.id.homePageRevampNoteMenu)
    public void handleClickMenu(){
        drawerLayout.openDrawer(GravityCompat.END);
    }

    @OnClick(R.id.homePageRevampNoteMenuTitle)
    ...
    @OnClick(R.id.homePageRevampNoteMenuClassify)
    ...
    @OnClick(R.id.homePageRevampNoteMenuSelectPhoto)
