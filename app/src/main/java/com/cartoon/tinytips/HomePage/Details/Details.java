...
import com.cartoon.tinytips.HomePage.Details.Revamp.DetailsRevamp;
...
public class Details extends BaseActivity<DetailsPresenter>
        implements IDetails.View{
    ...
    @Override
    protected DetailsPresenter initPresent(){
    ...
    public void handleClickDelete(){
        ...
        popupWindow.showAtLocation(Details.this.findViewById(R.id.homePageDetails),
    ...
    public void handleClickRevamp(){
        intent=new Intent(this, DetailsRevamp.class);
