package com.cartoon.tinytips.util.Adapter.Community.Hot;
...
public class CommunityHotAdapter extends RecyclerView.Adapter<CommunityHotAdapter.ViewHolder>{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        @BindView(R.id.communityHotAuthor) TextView noteAuthor;             //笔记作者
        @BindView(R.id.communityHotDetails) TextView noteDetails;            //笔记的标题
        @BindView(R.id.communityHotLike) TextView noteLike;              //笔记点赞数
        @BindView(R.id.communityHotComment) TextView noteComment;           //笔记评论数
        @BindView(R.id.communityHotMore) TextView more;                  //更多操作
        CardView cardView;
        View view;
