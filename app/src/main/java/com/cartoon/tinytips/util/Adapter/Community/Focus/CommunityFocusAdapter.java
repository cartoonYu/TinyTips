package com.cartoon.tinytips.util.Adapter.Community.Focus;
...
public class CommunityFocusAdapter extends RecyclerView.Adapter<CommunityFocusAdapter.ViewHolder>{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.communityFocusAuthor) TextView noteAuthor;             //笔记作者
        @BindView(R.id.communityFocusDetails) TextView noteDetails;            //笔记的标题
        @BindView(R.id.communityFocusLike) TextView noteLike;              //笔记点赞数
        @BindView(R.id.communityFocusComment) TextView noteComment;           //笔记评论数
        @BindView(R.id.communityFocusMore) TextView more;                  //更多操作
        CardView cardView;
        View view;
